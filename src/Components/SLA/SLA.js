                    ...
                    <div className="contents">
                        ...
                        <div className="table-container">
                            <div className="SLA-headings">
                                ...
                                <span className="headings-item"><IoMdMenu size={20} /> SLA Definition</span>
                            ...
                            <div className="SLA-record-resolution">
                                ...
                                <span className="record-item">
                                    ...
                                    <div className="progress-bar-parent">
                                        <div className="progress-resolution-child"></div>
                                    </div>
                                </span>
                            </div>
                            ...
                            <div className="SLA-record-response">
                                ...
                                <span className="record-item">
                                    33.22%
                                    <div className="progress-bar-parent">
                                        <div className="progress-response-child"></div>
                                    </div>
                                </span>
                            </div>
                        </div>
    ...
    return (
        <div className='SLA-section'>
            ...
            <div className='SLA-tabs-container'>
                ...
                <div className='SLA-tabs flex flex-row mb-1 border border-gray-300'>
